...
rule saturation_plot_bowtie_single:
  ...
  output:
    png = "../results/qc/bowtie2_saturation_multireads/{genome}/single/{singleEndName}.png",
    report = "../results/qc/bowtie2_saturation_multireads/{genome}/single/{singleEndName}.txt"
  threads: 1
...
rule saturation_plot_bowtie_paired:
  ...
  output:
    png = "../results/qc/bowtie2_saturation_multireads/{genome}/paired/{pairedEndName}.png",
    report = "../results/qc/bowtie2_saturation_multireads/{genome}/paired/{pairedEndName}.txt"
  threads: 1
  conda: "../envs/rCoreAndLibraries.yaml"
