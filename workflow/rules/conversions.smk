...
rule fasterq_dump_single:
  ...
  output:
    singleFastq = temp("../results/data/single/{singleEndName}.fastq")
  threads: 20
...
rule fasterq_dump_paired:
  ...
  output:
    pairedFastq_1 = temp("../results/data/paired/{pairedEndName}_1.fastq"),
    pairedFastq_2 = temp("../results/data/paired/{pairedEndName}_2.fastq")
  threads: 20
  conda: "../envs/parallelfastqdump.yaml"
...
rule gzip_fastq_single:
  ...
  output:
    singleFastq = temp("../results/data/single/{singleEndName}.fastq.gz")
  threads: 1
...
rule gzip_fastq_paired1:
  ...
  output:
    pairedFastq_1 = temp("../results/data/paired/{pairedEndName}_1.fastq.gz")
  threads: 1
...
rule gzip_fastq_paired2:
  ...
  output:
    pairedFastq_2 = temp("../results/data/paired/{pairedEndName}_2.fastq.gz")
  threads: 1
